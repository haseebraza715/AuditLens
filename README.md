...
- **Layer 1 — deterministic statistical checks (always on):** class imbalance, differential missingness, sensitive-column ↔ target correlation, demographic-parity gaps. Same CSV in → same findings out.
