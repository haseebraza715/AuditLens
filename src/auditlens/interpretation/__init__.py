...
def __getattr__(name: str) -> Any:
    ...
    if name == "build_layer2_graph":
        from auditlens.interpretation.graph import (
            build_layer2_graph as _build_layer2_graph,
        )

        return _build_layer2_graph
    if name == "run_layer2_pipeline":
        from auditlens.interpretation.pipeline import (
            run_layer2_pipeline as _run_layer2_pipeline,
        )
